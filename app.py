...
def admin_integrations():
    ...
    endpoints = [
        ...
        },
        {
            ...
            'description': 'Webhook for Meta (Facebook) Ads leads. Meta sends JSON payload with page_id and leadgen_id; admin is identified automatically from connected pages.',
            'sample_request': {
                "entry": [{
                    "id": "PAGE_ID",
                    "changes": [{
